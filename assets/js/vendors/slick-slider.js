...
! function() {
    ...
    s = document.querySelectorAll(".slider-8-columns"), s.length && s.forEach(function(s) {
        s = s.id;
        e("#" + s, {
            infinite: !0,
            slidesToShow: 8,
    ...
    }), s = document.querySelectorAll(".product-slider-second"), s.length && s.forEach(function(s) {
        s = s.id;
        e("#" + s, {
            infinite: !0,
            slidesToShow: 5,
    ...
    }), s = document.querySelector(".slider-for"), s && $(s).slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        arrows: !1,
        fade: !0,
        asNavFor: ".slider-nav"
    }), s = document.querySelector(".slider-nav"), s && $(s).slick({
        slidesToShow: 4,
        slidesToScroll: 1,
        asNavFor: ".slider-for",
        dots: !1,
        ...
        prevArrow: '<span class="slick-prev"><i class="feather-icon icon-chevron-left"></i></span>',
        nextArrow: '<span class="slick-next"><i class="feather-icon icon-chevron-right"></i></span>'
    }), s = document.querySelector(".product-slider-four-column"), s && e(s, {
        infinite: !0,
        slidesToShow: 4,
        slidesToScroll: 1,
        autoplay: !0,
